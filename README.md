...
find the download link to the original zip file, [(download)](https://web.archive.org/web/20200906162331if_/https://dlcdnets.asus.com/pub/ASUS/ZenFone/ZE620KL/UL-ASUS_X00QD-ASUS-AOSP-17.0615.2005.25-1.1.1-user.zip), **note that i _highly_ recommend downloading the build from \
